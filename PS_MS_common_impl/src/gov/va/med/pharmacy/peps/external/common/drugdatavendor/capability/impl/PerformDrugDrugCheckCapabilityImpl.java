...
public class PerformDrugDrugCheckCapabilityImpl implements PerformDrugDrugCheckCapability {
     ...
     */
    public final DrugCheckResultsVo<DrugDrugCheckResultVo> performDrugDrugCheck(ScreenDrugs screenDrugs,
            Map<String, DrugCheckVo> drugMap, boolean prospectiveOnly, boolean customTables) {
...
//                false, "");
            DDIMScreenResults fdbResults = screening.DDIMScreen(screenDrugs, prospectiveOnly,
                    FDBDDIMSeverityFilter.fdbDDIMSFUnknownModerate, customTables, customTables, customTables, "",
                    false, "");
    ...
    private DrugCheckResultsVo<DrugDrugCheckResultVo> convertResults(DDIMScreenResults screenResults,
        ...
        for (DDIMScreenResult result : filtered) {
            ...
            // The following lines were commented out in reference to CCR 5171.  Since Consumer Monographs will
            // be added back in the future, I did not want to delete all of this code.
//            try {
