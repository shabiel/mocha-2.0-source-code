...
public class ProcessOrderChecksCapabilityImpl implements ProcessOrderChecksCapability {
     ...
     */
    public final void setVersionCapability(VersionCapability versionCapability) {
        this.versionCapability = versionCapability;
    }

    /**
     * Sets the Perform Drug Checks Capability.
     * 
     * @param performDrugChecksCapability performDrugChecksCapability property
     */
    public final void setPerformDrugChecksCapability(PerformDrugChecksCapability performDrugChecksCapability) {
