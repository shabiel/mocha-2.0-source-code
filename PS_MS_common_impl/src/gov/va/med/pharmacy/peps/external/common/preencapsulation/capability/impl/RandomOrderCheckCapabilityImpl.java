...
/**
 * The Random Order Check Capability implementation.
 */
public class RandomOrderCheckCapabilityImpl implements RandomOrderCheckCapability {
    // NOPMD
...
//     */
//    public enum DrugCheckType {
//        DRUG_DOSE, DRUG_DRUG, DRUG_THERAPY, RANDOM, ALL;
//    }
     ...
     */
    public final String getRandomOrderCheck(DrugCheckType drugCheckType) {
        try {
            initialize();
    ...
    private List<BigInteger> getAvailableGcnSequenceNumbers() {
        ...
        return jdbcTemplate.queryForList(sql, BigInteger.class);
    }
    ...
    private void populateDoseInformation(BigInteger gcn, DoseInformation doseInformation) {
        ...
        String sql = "SELECT DOSEROUTEID, DOSETYPEID, DOSELOWUNITS FROM FDB_DOSERANGECHECK WHERE GCNSEQNO = ? AND "
                + "DOSELOWUNITS IS NOT NULL";
    ...
    private RouteType getDoseRoute(String doseRouteId) {
        ...
        String routeType = (String) jdbcTemplate.queryForObject(sql, new Object[] {doseRouteId}, String.class);
    ...
    private DoseTypeType getDoseType(String doseTypeId) {
        ...
        String doseType = (String) jdbcTemplate.queryForObject(sql, new Object[] {doseTypeId}, String.class);
    ...
    private int randomPositiveInt(int n) {
        ...
        return Math.abs(RANDOM.nextInt(Math.abs(n)));
    }
