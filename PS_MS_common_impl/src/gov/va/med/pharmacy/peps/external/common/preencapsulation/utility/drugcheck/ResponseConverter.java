...
public final class ResponseConverter {
    ...
    private static DrugDoseChecks toDrugDoseChecks(DrugCheckResultsVo<DrugDoseCheckResultVo> drugDoseCheckResults,
        ...
        if (!drugDoseCheckResults.getChecks().isEmpty()) {
            for (DrugDoseCheckResultVo result : drugDoseCheckResults.getChecks()) {
                ...
                drugDoseCheck.setFrequencyHigh(result.getDoseFrequencyHigh());
                drugDoseCheck.setFrequencyLow(result.getDoseFrequencyLow());
                ...
                drugDoseCheck.setMaxSingleNTEDose(result.getMaxSingleNTEDose());
                drugDoseCheck.setMaxSingleNTEDoseUnit(result.getMaxSingleNTEDoseUnit());
                drugDoseCheck.setMaxSingleNTEDoseForm(result.getMaxSingleNTEDoseForm());
                drugDoseCheck.setMaxSingleNTEDoseFormUnit(result.getMaxSingleNTEDoseFormUnit());
                
                drugDoseCheck.setMaxLifetimeOrderMessage(result.getMaxLifetimeOrderMessage());
                drugDoseCheck.setMaxLifetimeOrderStatus(result.getMaxLifetimeOrderStatus());
                drugDoseCheck.setMaxLifetimeOrderStatusCode(result.getMaxLifetimeOrderStatusCode());
                
                drugDoseCheck.setDaily(convertToCalculatedDose(result.getDaily()));
                drugDoseCheck.setMaxDaily(convertToCalculatedDose(result.getMaxDaily()));
                drugDoseCheck.setRangeLow(convertToCalculatedDose(result.getRangeLow()));
                drugDoseCheck.setRangeHigh(convertToCalculatedDose(result.getRangeHigh()));
                drugDoseCheck.setMaxLifetime(convertToCalculatedDose(result.getMaxLifetime()));
                drugDoseCheck.setMaxLifetimeOrder(convertToCalculatedDose(result.getMaxLifetimeOrder()));
                drugDoseCheck.setSingle(convertToCalculatedDose(result.getSingle()));
    ...
    /**
     * A method to convert a CalculatedDoseVo object to a CalculatedDose object for XML purposes.
     * 
     * @param calculatedDoseVo the CalculatedDoseVo object
     * @return CalculatedDose
     */
    private static CalculatedDose convertToCalculatedDose(CalculatedDoseVo calculatedDoseVo) {
        CalculatedDose calculatedDose = new CalculatedDose();
        calculatedDose.setDatabaseValue(calculatedDoseVo.getDatabaseValue());
        calculatedDose.setDoseValue(calculatedDoseVo.getDoseValue());
        calculatedDose.setPercentError(calculatedDoseVo.getPercentError());
        calculatedDose.setUnitOfMeasure(calculatedDoseVo.getUnitOfMeasure());
        return calculatedDose;
    }
    /**
