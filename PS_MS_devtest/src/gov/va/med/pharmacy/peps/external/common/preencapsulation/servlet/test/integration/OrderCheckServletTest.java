...
public class OrderCheckServletTest extends OrderCheckTestCase {
     ...
     * @throws Exception
     */
    public void testOrderCheckBigIncludeCustom() throws Exception {
        assertActualResponseEqual("xml/test/messages/orderCheckBigIncludeCustom.xml", "xml/test/messages/orderCheckBigResponse.xml");
    }
    ...
    /**
     * Test CONT INTRAOSSEOUS Dose Range Drug Dose Check.
     * 
     * @throws Exception
     */
    public void testContIntraosseousDrugDose() throws Exception {
        assertActualResponseEqual("xml/test/messages/contIntraosseousDrugDoseCheck.xml", "xml/test/messages/contIntraosseousDrugDoseCheckResponse.xml");
    }
}